...
#             data = utils.to_var(data)
        ...
        tr_auprc_3, tr_roc_auc_3, tr_auprc_7, tr_roc_auc_7, tr_auprc_11, tr_roc_auc_11 = evaluate(model, tr_loader)
        va_auprc_3, va_roc_auc_3, va_auprc_7, va_roc_auc_7, va_auprc_11, va_roc_auc_11 = evaluate(model, val_loader)
        te_auprc_3, te_roc_auc_3, te_auprc_7, te_roc_auc_7, te_auprc_11, te_roc_auc_11 = evaluate(model, test_loader)
        
        
        for min_los, tr_auprc, tr_auc, val_auprc, val_auc, test_auprc, test_auc in [('3', tr_auprc_3, tr_roc_auc_3,
                                                                                    va_auprc_3, va_roc_auc_3, 
                                                                                    te_auprc_3, te_roc_auc_3),
                                                                                   ('7', tr_auprc_7, tr_roc_auc_7,
                                                                                    va_auprc_7, va_roc_auc_7, 
                                                                                    te_auprc_7, te_roc_auc_7),
                                                                                   ('11', tr_auprc_11, tr_roc_auc_11,
                                                                                    va_auprc_11, va_roc_auc_11, 
                                                                                    te_auprc_11, te_roc_auc_11)]:
        
            print('========================LOS > %s prediction ========================================'%min_los)
        ...
        curr_perf_dict = {'loss': run_loss / (idx + 1.0),
                         'AUC_train_3' : tr_roc_auc_3,
                         'AUC_valid_3' : va_roc_auc_3,
                         'AUC_test_3' : te_roc_auc_3,
                         'AUPRC_train_3' : tr_auprc_3,
                         'AUPRC_valid_3' : va_auprc_3,
                         'AUPRC_test_3' : te_auprc_3,
                         'AUC_train_7' : tr_roc_auc_7,
                         'AUC_valid_7' : va_roc_auc_7,
                         'AUC_test_7' : te_roc_auc_7,
                         'AUPRC_train_7' : tr_auprc_7,
                         'AUPRC_valid_7' : va_auprc_7,
                         'AUPRC_test_7' : te_auprc_7,
                         'AUC_train_11' : tr_roc_auc_11,
                         'AUC_valid_11' : va_roc_auc_11,
                         'AUC_test_11' : te_roc_auc_11,
                         'AUPRC_train_11' : tr_auprc_11,
                         'AUPRC_valid_11' : va_auprc_11,
                         'AUPRC_test_11' : te_auprc_11,
                         }
...
#         data = utils.to_var(data)
    ...
    y_N3, y_pred_proba_N3, auprc_3, roc_auc_3, y_N7, y_pred_proba_N7, auprc_7, roc_auc_7, y_N11, y_pred_proba_N11, auprc_11, roc_auc_11 = compute_binary_classification_perf(labels[:, 0], preds)
        
    return auprc_3, roc_auc_3, auprc_7, roc_auc_7, auprc_11, roc_auc_11
...
#     y_test_np_filename = os.path.join(data_save_dir, 'y_test.npy')  
    ...
    model = getattr(models, args.model).Model(args.hid_size, args.impute_weight, args.label_weight, outcome_type='ordinal')
