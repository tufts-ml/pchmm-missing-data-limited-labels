...
----------------------
$ snakemake --snakefile train_semi_supervised_FixMatch.smk --profile ../../../profiles/hugheslab_cluster/ train_and_evaluate_classifier_many_hyperparams
...
rule train_and_evaluate_classifier:
    input:
        script=os.path.join(PROJECT_REPO_DIR, 'src', 'FixMatch', 'main.py'),
