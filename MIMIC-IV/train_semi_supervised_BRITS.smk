...
----------------------
$ snakemake --snakefile train_semi_supervised_BRITS.smk --profile ../../../profiles/hugheslab_cluster/ train_and_evaluate_classifier_many_hyperparams
...
RESULTS_FEAT_PER_TSTEP_PATH="results/BRITS/"
...
rule train_and_evaluate_classifier:
    input:
        script=os.path.join(PROJECT_REPO_DIR, 'src', 'BRITS', 'main.py'),
