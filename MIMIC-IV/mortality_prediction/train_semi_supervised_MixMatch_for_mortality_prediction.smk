...
Usage
-----
snakemake --cores 1 --snakefile train_semi_supervised_MixMatch_for_mortality_prediction.smk train_and_evaluate_classifier_many_hyperparams

Schedule as slurm jobs
----------------------
$ snakemake --snakefile train_semi_supervised_MixMatch_for_mortality_prediction.smk --profile ../../utils/profiles/hugheslab_cluster/ train_and_evaluate_classifier_many_hyperparams
...
RESULTS_FEAT_PER_TSTEP_PATH=os.path.abspath("../results/MixMatch/mortality_prediction")
CLF_TRAIN_TEST_SPLIT_PATH = "/cluster/tufts/hugheslab/datasets/MIMIC-IV/mortality_prediction/"
PROJECT_REPO_DIR = os.path.abspath("../MixMatch")
