...
import os
import json
PROJECT_SRC_DIR = os.path.abspath('../../MIMIC-IV')
...
#                          tf.keras.callbacks.LearningRateScheduler(scheduler)
    ...
    y_train_N3, y_train_pred_proba_N3, train_auprc_3, train_roc_auc_3, y_train_N5, y_train_pred_proba_N5, train_auprc_5, train_roc_auc_5, y_train_N7, y_train_pred_proba_N7, train_auprc_7, train_roc_auc_7 = compute_binary_classification_perf(train_y, y_train_pred_proba_NC)
    ...
    y_valid_N3, y_valid_pred_proba_N3, valid_auprc_3, valid_roc_auc_3, y_valid_N5, y_valid_pred_proba_N5, valid_auprc_5, valid_roc_auc_5, y_valid_N7, y_valid_pred_proba_N7, valid_auprc_7, valid_roc_auc_7 = compute_binary_classification_perf(valid_y, y_valid_pred_proba_NC)
    ...
    y_test_N3, y_test_pred_proba_N3, test_auprc_3, test_roc_auc_3, y_test_N5, y_test_pred_proba_N5, test_auprc_5, test_roc_auc_5, y_test_N7, y_test_pred_proba_N7, test_auprc_7, test_roc_auc_7 = compute_binary_classification_perf(test_y, y_test_pred_proba_NC)
