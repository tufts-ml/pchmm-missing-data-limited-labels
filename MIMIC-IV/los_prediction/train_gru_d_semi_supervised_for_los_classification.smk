...
----------------------
$ snakemake --snakefile train_gru_d_semi_supervised_for_los_classification.smk --profile ../../../profiles/hugheslab_cluster/ train_and_evaluate_classifier_many_hyperparams
...
rule train_and_evaluate_classifier:
    input:
        script=os.path.join(PROJECT_REPO_DIR, 'GRU_D', 'main_mimic_semi_supervised.py'),
