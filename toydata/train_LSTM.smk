'''
Train rnn ON Toy Overheat Binary Classification
...
rule train_and_evaluate_classifier:
    ...
    params:
        ...
        fn_prefix="LSTM-missing_handling={missing_handling}-perc_obs={perc_obs}-lr={lr}-dropout={dropout}-l2_penalty={l2_penalty}-seed={seed}"
    
    output:
        os.path.join(RESULTS_FEAT_PER_TSTEP_PATH, "final_perf_LSTM-missing_handling={missing_handling}-perc_obs={perc_obs}-lr={lr}-dropout={dropout}-l2_penalty={l2_penalty}-seed={seed}.csv")
